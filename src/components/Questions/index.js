    ...
    return (
        <React.Fragment>
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell align="center" component="th" scope="row">
                    <Alert severity={row.isEnable==true? "success" : "error"} sx={{justifyContent:'center'}}>
                ...
                <TableCell align="center">
                    ...
                    <button className="btn btn-primary" style={{border:'none',outline:'none',cursor:'default',backgroundColor:'transparent'}}></button>
                        ...
                        <div dir="rtl">
                            <TableContainer component={Paper}>
                                <Table aria-label="collapsible table">
                                    ...
                                    <TableBody>
                                        {(rowsPerPage > 0
                                                ? questionsList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                                : questionsList
                                        ).map((row) => (
                                    ...
                                    <TableFooter>
                                        <TableRow>
                                            <TablePagination
                                                ...
                                                labelDisplayedRows={ (from=page) => (`${enToFaDigits(from.from)} - ${enToFaDigits(from.to === -1 ? from.count : from.to)}  از  ${enToFaDigits(from.count)}`)}
                                                labelRowsPerPage={'تعداد در هر صفحه'}
                                                rowsPerPageOptions={[{ label: '۵', value: 5 }, { label: '۱۰', value: 10 }, { label: '۲۵', value: 25 }, { label: 'همه', value: -1 }]}
                                                colSpan={3}
