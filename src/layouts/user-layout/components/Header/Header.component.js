        ...
        <Box sx={{ display: 'flex' }}>
            <AppBar component="nav" sx={{backgroundColor:'rgb(45,55,145)'}}>
                <Toolbar>
                    ...
                    <Avatar onClick={()=>{navigate(PATHS.HOME)}} sx={{ backgroundColor: 'transparent' , flexGrow: 1, mt:1, display: { xs: 'inline', sm: 'none'}}} variant="rounded">
                    ...
                    >
                        <DialogTitle>{"آیا قصد خروج از حساب کاربری خود را دارید؟"}</DialogTitle>
                        <DialogContent>
